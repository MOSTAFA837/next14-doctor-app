...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-500 bg-white border-t border-gray-200">
      <div className="px-4 py-5 mx-auto md:px-14">
        ...
        <div className="mt-12 py-6 border-t items-center justify-between sm:flex sm:mt-0">
